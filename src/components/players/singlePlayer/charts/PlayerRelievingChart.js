...
export default class PlayerRelievingChart extends Component {
  constructor(props) {
    super(props);
    this.state = {
      statsOne: "",
  ...
  render() {
    ...
    const { reliefData } = this.props;
    const objectKeys = Object.keys(reliefData[0]);
    ...
    return (
      <div className="border pt-2 pl-2 pr-2 mb-3 border-dark">
        <div className="mb-3">
          <h5>Select Relief Pitching Stats to Compare</h5>
          <select
            className="mr-2"
            name=""
            id="statsOne"
