...
export default class PlayerStartingChart extends Component {
  constructor(props) {
    super(props);
    this.state = {
      statsOne: "",
  ...
  render() {
    ...
    const objectKeys = Object.keys(startingData[0]);
    const keys = objectKeys.slice(3);

    let season = [];
    startingData.map(year => {
    ...
    return (
      <div className="border pt-2 pl-2 pr-2 mb-3 border-dark">
        <div className="mb-3">
          <h5>Select Starting Pitching Stats to Compare</h5>
          <select
            className="mr-2"
            name=""
            id="statsOne"
